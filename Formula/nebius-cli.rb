class NebiusCli < Formula
  ...
  on_macos do
    on_arm do
      version "0.12.236" # @github-actions-macos-latest@
      url "https://storage.eu-north1.nebius.cloud/cli/release/#{version}/darwin/arm64/nebius", using: :nounzip
    end
    on_intel do
      version "0.12.236" # FIXME: @github-actions-macos-latest@ but not exactly
  ...
  on_linux do
    on_arm do
      version "0.12.236" # FIXME: @github-actions-ubuntu-latest@ but not exactly
      url "https://storage.eu-north1.nebius.cloud/cli/release/#{version}/linux/arm64/nebius", using: :nounzip
    end
    on_intel do
      if Hardware::CPU.is_64_bit?
        version "0.12.236" # FIXME: @github-actions-ubuntu-latest@
